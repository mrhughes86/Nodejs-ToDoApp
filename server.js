...
let connectionString = 'mongodb+srv://markus86:nintendo86@cluster0.t6jar.mongodb.net/TodoApp?retryWrites=true&w=majority';
...
function passwordProtected(req, res, next){
  ...
  if(req.headers.authorization == "Basic bXl0b2RvbGlzdDpodWdoZXM="){
    next()
  } else {
